#!/usr/bin/env python3
"""
Generate Fig 4 and Fig 6 panels for seed 45 from CSV files.

Panels: SW2 vs N_sim, SW2 vs Time, Epsilon vs N_sim, Epsilon vs Time.
Uses n_sim and time "per 1000 unique".

Usage:
    PYENV_VERSION=permabc pyenv exec python experiments/scripts/generate_fig4_fig6_seed45.py
"""
import sys
...
def main():
    ...
    # Fig 4: K=20, outliers=0 (CSV is osum_True, we exclude OSUM methods)
    csv_fig4 = RESULTS_DIR / f"performance_K_20_outliers_0_osum_True_seed_{seed}.csv"
    if csv_fig4.exists():
